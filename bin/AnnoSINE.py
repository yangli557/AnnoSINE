...
parser.add_argument("-s", "--shift",  type=int, default=50,
...
parser.add_argument("-minc", "--copy_number", type=int, default=20,
...
parser.add_argument("-b", "--boundary", type=str, default='msa',
...
parser.add_argument("-r", "--nonredundant", type=str, default='y',
...
def genome_annotate(in_genome_assembly_path, out_genome_assembly_path, in_nonredundant):
    #path = os.path.abspath(os.path.dirname(os.getcwd()))
    print(in_genome_assembly_path.replace('..', ''))
...
def main_function():
    ...
    input_nonredundant = args.nonredundant
    ...
    genome_annotate(input_genome_assembly_path, output_genome_assembly_path, input_nonredundant)
